...
// Using filter method of an array.
console.log(ancestry.filter(function(person) {
    return person.father == "Carel Haverbeke";
}));

// Implementation of map for transforming an array by applying a function to all of
// its elements.
...
var overSixty = ancestry.filter(function(person) {
